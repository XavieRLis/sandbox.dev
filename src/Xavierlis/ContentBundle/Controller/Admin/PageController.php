...
use Xavierlis\ContentBundle\Entity\Page;
use Xavierlis\ContentBundle\Form\PageType;
...
class PageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('XavierlisContentBundle:Page')->findAll();

        return $this->render('XavierlisContentBundle:Page:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('XavierlisContentBundle:Page')->find($id);
        ...
        return $this->render('XavierlisContentBundle:Page:show.html.twig', array(
            'entity'      => $entity,
